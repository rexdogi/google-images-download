...
def user_input():
    ...
    if object_check['config_file'] != '':
        ...
        parser.add_argument('-nd', '--no_download', default=False, help='scraped urls will not be downloaded', type=str,
                            required=False)
...
class googleimagesdownload:
    ...
    def download_image(self, image_url, image_format, main_directory, dir_name, count, print_urls, socket_timeout,
                       prefix, print_size, no_numbering):
        if print_urls:
            print("Image URL: " + image_url)
        try:
            req = Request(image_url, headers={
    ...
    def _get_all_items(self, page, main_directory, dir_name, limit, arguments):
        ...
        while count < limit + 1:
            ...
            if object == "no_links":
                ...
                # download the images
                if arguments['no_download'] is None:
                    download_status, download_message, return_image_name, absolute_path = self.download_image(
                        ...
                        arguments['print_urls'], arguments['socket_timeout'], arguments['prefix'],
                        arguments['print_size'], arguments['no_numbering'])
